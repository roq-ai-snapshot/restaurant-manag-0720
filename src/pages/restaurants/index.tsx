...
export function RestaurantListPage(props: RestaurantListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getRestaurants({
        relations: ['user', 'menu.count', 'seating.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('menu', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('seating', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'seating',
          header: 'Seating',
          accessorKey: 'seating',
          cell: ({ row: { original: record } }: any) => record?._count?.seating,
        }
      : null,
