...
-- AddForeignKey
ALTER TABLE "seating" ADD CONSTRAINT "seating_restaurant_id_fkey" FOREIGN KEY ("restaurant_id") REFERENCES "restaurant"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
